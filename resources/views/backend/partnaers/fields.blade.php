...
<div class="card-body">
    ...
    <input type="text" class="form-control" id="name"@isset($partnaer)  value="{{ $partnaer->title }}" @endisset value="{{ old('title') }}" name="title" placeholder="enter name partnaer">
    </div>

    <div class="form-group">
        <label for="link">Link</label>
        <input type="text" class="form-control" id="link" @isset($partnaer) value="{{ $partnaer->link }}" @endisset value="{{ old('link') }}"  name="link" placeholder="enter link partnaer">
      </div>
