...
<div class="table-responsive">
    ...
    <div class="card">
        <div class="card-header">
          <h3 class="card-title">
            <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{{ route('admin.sector.create') }}">Add Sector</a>
          </h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                    ...
                    <td>{{ $sector->created_at }}</td>
                        <td>
                            ...
                            <div class='btn-group'>
                                ...
                                <a href="{{ route('admin.sector.edit', [$sector->id]) }}" class='btn btn-default btn-xs'><i class="fa fa-edit"></i></a>
